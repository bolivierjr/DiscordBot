...
display_default_response = (
    f"**New York, New York** :: Light Rain 52.6F/11.4C (Humidity: 82%) | "
    f"**Feels like**: 52.6F/11.4C | **Wind**: WNW at 12.8mph/20.6kph | "  # noqa: E501
    f"**Today**: Light rain in the morning and afternoon. High 54.3F/12.4C"
    f" - Low 42.6F/5.9C"
)

display_cf_response = (
    f"**New York, New York** :: Light Rain 11.4C/52.6F (Humidity: 82%) | "
    f"**Feels like**: 11.4C/52.6F | **Wind**: WNW at 20.6kph/12.8mph | "  # noqa: E501
    f"**Today**: Light rain in the morning and afternoon. High 12.4C/54.3F"
    f" - Low 5.9C/42.6F"
)
